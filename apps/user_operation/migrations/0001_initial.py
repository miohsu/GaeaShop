    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.CharField(default='', max_length=64, verbose_name='区域')),
                ...
                ('signer_mobile', models.CharField(default='', max_length=32, verbose_name='电话')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message_type', models.IntegerField(choices=[(1, '留言'), (2, '投诉'), (3, '询问'), (4, '售后'), (5, '求购')], help_text='留言类型: 1(留言),2(投诉),3(询问),4(售后),5(求购)', verbose_name='留言类型')),
